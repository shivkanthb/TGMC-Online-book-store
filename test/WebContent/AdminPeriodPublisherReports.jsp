...
%>
		...
		<form class="form_settings" method="post" action="AdminPeriodPublisherReports.jsp" id="form1">
	...
	%>
				...
				String query = "SELECT BOOKS.PUBID,NAME,SUM(QUANTITY) FROM PUBLISHER,BOOKS,TRANSACTION WHERE BILLID IN (SELECT BILLID FROM BILL WHERE BILL_DATE BETWEEN ? AND ? ) AND BOOKS.ISBN=TRANSACTION.ISBN AND PUBLISHER.PUBID=BOOKS.PUBID GROUP BY NAME,BOOKS.PUBID";
