...
int z= Integer.parseInt(request.getParameter("no_copies"));
...
String query1="";
	...
	%>
	  ...
	  query="UPDATE CATALOGUE SET NO_COPIES=? WHERE ISBN=?";
...
<%}
	query1="UPDATE BOOKS SET TITLE=? WHERE ISBN=?";
