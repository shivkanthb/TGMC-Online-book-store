...
<form class="form_settings" method="post" action="AdminPublisherReports.jsp" id="form1">
...
<% int xx=0; %>
	...
	%>
			...
			String query = "SELECT BOOKS.PUBID,NAME,SUM(QUANTITY) FROM PUBLISHER,BOOKS,TRANSACTION WHERE BILLID IN (SELECT BILLID FROM BILL WHERE BILL_DATE=? ) AND BOOKS.ISBN=TRANSACTION.ISBN AND PUBLISHER.PUBID=BOOKS.PUBID GROUP BY NAME,BOOKS.PUBID";
