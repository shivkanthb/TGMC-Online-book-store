...
<form class="form_settings" method="post" action="AddPublisher.jsp" onSubmit="return valPub();">
...
<td>
<label>Name: </label></td>
<td><input type="text" name="name" id="a">
</input></td>
</tr>

<tr>
<td><label>City : </label></td>
<td><input type="text" name="city" id="b"></input></td>
</tr>
