...
String y= request.getParameter("title");

int z= Integer.parseInt(request.getParameter("pages"));
String a= request.getParameter("edition");
int b= Integer.parseInt(request.getParameter("year"));
...
String query="";
	...
	%>
	  ...
	  query="UPDATE BOOKS SET TITLE=?,NO_OF_PAGES=?,EDITION=?,YEAR=?,RATING=?,DESCRIPTION=?  WHERE ISBN=?";
