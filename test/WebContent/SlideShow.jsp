...
<label>CAPTION: </label><input type="text" name="desc" id="desc" ></input><br></br>

<button class="form_button" onclick="check()">Add</button>
...
<script>
	function check()
	{
		...
		ajx.open("GET","AddImagesToSlideshow.jsp?name="+n+"&desc="+d,true);
		ajx.send()
			}
			}
