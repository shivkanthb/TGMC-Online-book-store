...
<div id="disp"></div>
    ...
    <div class="bookshow">
    	 	<form id="form1" action="index.jsp" ></form>
		<label>User Name : <input id='us' type="text" name="usid"></input></label> <br/><label>Password
			: <input type="password" name="pwd" id='pw'></input>
		</label><br/>
		<button class="form_button" onclick="check()">Login</button>
		<div id="test" style="color:red"></div>

<a href="ForgotPasswordInt.jsp" style="color:blue">Forgot your password?</a>
	</div>
	...
	function check()
	{
		...
		ajx.open("GET","log.jsp?usid="+us+"&pwd="+p,true);
		ajx.send()
	}
