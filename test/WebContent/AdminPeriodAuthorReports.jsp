...
%>
		...
		<form class="form_settings" method="post" action="AdminPeriodAuthorReports.jsp" id="form1">
	...
	%>
				...
				String query = " SELECT AUTHOR.AUTHORID,FIRSTNAME,LASTNAME,SUM(QUANTITY) FROM AUTHOR,AUTH_BOOKS,TRANSACTION WHERE BILLID IN (SELECT BILLID FROM BILL WHERE BILL_DATE BETWEEN ? AND ?) AND AUTH_BOOKS.ISBN=TRANSACTION.ISBN AND AUTHOR.AUTHORID=AUTH_BOOKS.AUTHID GROUP BY FIRSTNAME,LASTNAME,AUTHOR.AUTHORID";
