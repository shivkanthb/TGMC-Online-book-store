...
<form class="form_settings" method="post" action="AdminCategoryReports.jsp" id="form1">
...
<%
	...
	%>
			...
			String query = " SELECT CATEGORY.CAT,CATEGORY.NAME,SUM(QUANTITY) FROM CATEGORY,BOOK_CAT,TRANSACTION WHERE BILLID IN (SELECT BILLID FROM BILL WHERE BILL_DATE=? ) AND BOOK_CAT.ISBN=TRANSACTION.ISBN AND CATEGORY.CAT=BOOK_CAT.CAT GROUP BY CATEGORY.NAME,CATEGORY.CAT";
