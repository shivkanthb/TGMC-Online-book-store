...
statement.setString(1, usid);
statement.setString(2, request.getParameter("fname"));
statement.setString(3, request.getParameter("lname"));
statement.setString(4, mob);
statement.setString(5, request.getParameter("mail"));
statement.setString(6, request.getParameter("addr"));
...
statement.setString(10, request.getParameter("gender"));
statement.setString(11, request.getParameter("typeofuser"));
statement.setString(12, request.getParameter("pincode"));
java.sql.Date d = new java.sql.Date(new java.util.Date().getTime());

statement.setDate(13,d);
try{
statement.executeUpdate();
%>
<p>You have Registered Successfully in our website.  A message is sent to your mobile.</p>
<%
...
String number=mob;
String msg="You have successfully registered in our website.  Thank you for choosing us" ; 
