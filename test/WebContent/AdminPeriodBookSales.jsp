...
%>
		...
		<form class="form_settings" method="post" action="AdminPeriodBookSales.jsp" id="form1">
	...
	%>
				...
				String query = " SELECT BOOKS.ISBN,TITLE,SUM(QUANTITY) FROM BOOKS,TRANSACTION WHERE BILLID IN (SELECT BILLID FROM BILL WHERE BILL_DATE BETWEEN ? AND ? ) AND BOOKS.ISBN=TRANSACTION.ISBN GROUP BY TITLE,BOOKS.ISBN";
