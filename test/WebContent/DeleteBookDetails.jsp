...
<p>You can delete only the books which have not been bought by anyone.</p>

<form method="post" action="Deletebookdb.jsp" class="form_settings">
<table border="0">
<tbody>
...
<td><input type="text" id="title" name="title" disabled="true"></input></td>
</tr>

<tr>
<td>
<label>Pages</label></td>
<td><input type="text" id="pages" name="pages" disabled="true"></input></td>
</tr>

<tr>
<td>
<label>Edition</label></td>
<td><input type="text" id="edition" name="edition" disabled="true"></input></td>
</tr>
...
<td>
<label>Year</label></td>
<td><input type="text" id="year" name="year" disabled="true"></input></td>
</tr>
...
<td><input type="text" id="rating" name="rating" disabled="true"></input></td>
</tr>

<tr>
<td>
<label>Description</label></td>
<td><input type="text" id="description" name="description" disabled="true"></input></td>
</tr>
...
<button class="form_button">Delete</button>
</td>
</tr>
...
<script>cha()</script><script type="text/javascript" src="js/search.js"></script></html>
