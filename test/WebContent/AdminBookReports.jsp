...
<form class="form_settings" method="post" action="AdminBookReports.jsp" id="form1">
...
<% int xx=0; %>
	...
	%>
			...
			String query = " SELECT BOOKS.ISBN,TITLE,SUM(QUANTITY) FROM BOOKS,TRANSACTION WHERE BILLID IN (SELECT BILLID FROM BILL WHERE BILL_DATE=? ) AND BOOKS.ISBN=TRANSACTION.ISBN GROUP BY TITLE,BOOKS.ISBN";
