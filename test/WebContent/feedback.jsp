...
<%} %>
       ...
       <form class="form_settings" method="post" action="contact.jsp" >
      
	   <h1>
	   Tell us about your issue..! </h1><br>
...
<textarea id="ta" cols="40" rows="3" name="myname">

</textarea>
</label>
<br><br>

<button class="form_button" align="center">Submit</button>
