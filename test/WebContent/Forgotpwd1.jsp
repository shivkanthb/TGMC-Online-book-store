...
String from="srinathbookstore@gmail.com";  // write your email address means from email address.
...
props.put("mail.smtp.password", "greatest/");
...
msg.setText("Your username and password is sent to you\nUsername:  "+us+"\nPassword : "+pwd);
...
transport.connect(host,from,"greatest/");
