...
<div id="disp"></div>
   ...
   <li class="show"><img width="680" height="250" src="images/<%=slide.getString(2) %>" alt="&quot;<%=slide.getString(3) %>&quot;" /></li><%} %>
	 ...
	 <div class="tileshow2">
			...
			<div class="tile2" style="background-color: orange">
				<a href="Popular.jsp">Popular</a>
			</div>

			<div class="tile2" style="background-color: blue">
				<a href="Newrelease.jsp">New Release</a>
			</div>

			
			<div class="tile2" style="background-color: green">
				<a href="PreOrder.jsp">Pre Order</a>
			</div>
			<div class="tile2" style="background-color: gold">
				<a href="Discount.jsp">Special Offers</a>
			</div>
		</div>
	</div>
...
<script type="text/javascript" src="js/search.js"></script><script>changeClass()</script></html>
